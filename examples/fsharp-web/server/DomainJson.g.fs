...
type ConvertDomain() =
    ...
    static member RequestFromJson(reader: byref<Utf8JsonReader>): Domain.Request voption =
        let mutable vToken = ""
    ...
    static member ResponseFromJson(reader: byref<Utf8JsonReader>): Domain.Response voption =
        let mutable vToken = ""
