...
type Op =
    ...
    static member MakeSumAllKey() = Key.Value "8"
    static member MakeZeroKey() = Key.Value "9"
    ...
    interface IEntity with
        member x.Key =
            ...
            | Op.SumAll(p1') -> Op.MakeSumAllKey()
            | Op.Zero -> Op.MakeZeroKey()


type OpError =
    | Unknown
    | General of p1: string list
    | DivisionByZero
    | NotSupported
